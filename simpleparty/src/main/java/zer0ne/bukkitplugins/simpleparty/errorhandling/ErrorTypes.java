...
public enum ErrorTypes {
	PlayerNotFound, PartyNotFound, PartyExisting, NoOwnerPermission, MaxMembersOverflow, SameNameError, PlayerAlreadyInAParty, NoInvitationAvailable, InvitationNotValid, PlayerNotInAParty
}
